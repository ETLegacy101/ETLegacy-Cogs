...
class Audio:
    ...
    async def np(self, ctx):
        ...
        if song:
            ...
            if hasattr(song, 'duration'):
                ...
                dur = None
            e = discord.Embed(title="**Now Playing in {}:**".format(server.me.voice_channel), colour=discord.Colour.green())
    ...
    async def _embed_np(self, message, server:discord.Server=None, channel:discord.Channel=None, author:discord.Member=None):
        ...
        if song:
            ...
            e = discord.Embed(title="Now playing in: {}".format(server.me.voice_channel), description="[{}]({})\nDuration: {}".format(song.title, song.webpage_url,  dur), colour=discord.Colour.blue())
            e.set_thumbnail(url=song.thumbnail)
